...
extension URL {
    //Return convert query to Dictionary
    ...
    //Return remote size of url, don't use it in main thread
    ...
    //Return server supports resuming or not, don't use it in main thread
    ...
    //Return last file access date, nil if file doesn't exist or not yet accessed
    ...
    //Return file size, -1 if file doesn't exist
