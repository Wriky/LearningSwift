...
//  LearningSwift
//
//  Created by wangyuan on 2018/12/21.
...
extension Array {
    ...
    public func get(at range: ClosedRange<Int>) -> Array {
        let halfOpenClampedRange = CountableRange(range)
...
extension Array where Element: Equatable {
    ...
    public func contais(_ array: [Element]) -> Bool {
...
extension Array where Element: Hashable {
    //Remove all occurrences of the given object(s)
    public mutating func removeAll(_ elements: [Element]) {
...
extension Collection {
    // Returns the element at specified index if it is within bounds, otherwise nil
