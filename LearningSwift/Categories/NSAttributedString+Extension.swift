...
extension NSAttributedString {
    //Return Adds bold attribute to NSAttributedString and returns it
    ...
    //Return Adds underline attribute to NSAttributedString and returns it
    ...
    //Return Adds italic attribute to NSAttributedString and returns it
    ...
    //Return Adds strikethrough attribute to NSAttributedString and returns it
    ...
    //Return Adds color attribute to NSAttributedString and returns it
...
//Return Appends one NSAttributedString to another NSAttributedString and returns it
...
//Return Sum of one NSAttributedString with another NSAttributedString
